...
**อัตราค่าซ่อมเก็บเป็น "ชุด" ได้ (`lib/store/repairSnapshots.ts`)** ระบบเก็บชุดปัจจุบันไว้ให้อัตโนมัติก่อนนำเข้าข้อมูลใหม่และก่อนสลับชุด ผู้ใช้จึงย้อนกลับไปชุดไหนก็ได้ ไม่ใช่แค่กลับไปฐานกลาง · **ต้อง `structuredClone` ตอนเก็บและตอนเรียกใช้** ไม่งั้นชุดที่สำรองไว้จะเปลี่ยนตามค่าที่ผู้ใช้แก้ต่อ แล้วย้อนกลับไม่ได้จริง
