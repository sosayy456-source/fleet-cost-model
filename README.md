...
**สเปกรถอยู่ใน `vehicles.json`** — รถที่ใช้งานปัจจุบัน 18 ชนิดมีปริมาตรบรรทุก (`volumeM3`, ม³)
และน้ำหนักบรรทุกสูงสุด (`capacityKg`, กก.) เป็นค่าเริ่มต้น ผู้ใช้แก้ได้จากหน้า “การตั้งค่า” โดยค่าที่แก้เก็บใน
localStorage ของเครื่องนั้น ช่องน้ำหนักในฟอร์มและการคำนวณ Load Factor ใช้หน่วยกิโลกรัมเสมอ
