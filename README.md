...
| `custmap.bin` หนัก 17.9 MB | commit ไว้ใน repo แล้ว (รหัสที่ hash ไว้ไม่ใช่ความลับ) โหลดเฉพาะตอนเข้าหน้าค้นรหัสกับหน้าบันทึกข้อมูล · สร้างใหม่ด้วย `python etl/build_custmap.py "แปลงรหัสลูกหนี้รวม.xlsx"` |
