...
4. คัดลอก URL ที่ลงท้าย `/exec` มาวางในแอป (หน้าบันทึกข้อมูล → ⚙ ตั้งค่าการเชื่อม)
...
| `custmap.bin` ไม่อยู่ใน repo | มาจากข้อมูลลูกค้าจริง สร้างในเครื่องด้วย `node app/tools/extract-custmap.mjs` |
