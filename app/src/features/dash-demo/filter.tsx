 ...
 *   ไฟล์ Load Factor (ข้อ 2 กล่อง 1–2 · การ์ดตัน-กม.)            → ปี · เดือน · ประเภทรถ · ชนิดรถ
 *   กำไรลูกค้า ส่วนที่ 1 (ชุด alloc/)                              → ปี · เดือน (ตามวันที่บิล)
...
const LABEL: Record<DemoKey, string> = {
  year: "ปี", month: "เดือน", o: "ต้นทาง", de: "ปลายทาง", ft: "ประเภทรถ", vk: "ชนิดรถ", sg: "กลุ่มบริการ",
};
...
export function FilterScope({ f, uses, why, who = "ส่วนนี้" }: {
  ...
  const skipped = ORDER.filter((k) => f[k] && !uses.includes(k));
