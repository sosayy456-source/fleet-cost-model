...
export interface Vehicle {
  ...
  approxFrom?: string;
  /**
   * ชนิดจากโมเดล v5 ที่ไม่มีรถวิ่งจริงในไฟล์ทะเบียนรถ — ซ่อนจากทุกดรอปดาวน์/ตัวกรอง
   * แต่ยังอยู่ในตารางเพราะใบเก่าที่บันทึกด้วยชนิดนี้ต้องคำนวณได้ และ golden test 123 เคสใช้อยู่
   */
  retired?: boolean;
}
