 ...
 *
 * กล่อง/การ์ดที่ลิงก์ไปแท็บของ Executive Dashboard ทุกตัววิ่งผ่าน openExecTab() (dashJump.ts) ตัวเดียว
 ...
 *   (เจ้าของงานแจ้งทั้งสองรอบ 25 ก.ย. 2569) — วัดแล้วเวลาส่วนใหญ่คือเบราว์เซอร์วาดหน้า Demo ~1.2 วิ (ข้อมูลอยู่ในแคชแล้ว)
